...
def run_missing_fill():
    print(f"Filling Missing Vault Data: {datetime.now(timezone.utc).strftime('%Y-%m-%d %H:%M UTC')}")
    
    for ig88_sym, binance_sym in MISSING_SYMBOLS.items():
